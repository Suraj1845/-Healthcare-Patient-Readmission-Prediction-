...
Developed a machine learning–based patient readmission prediction system using demographic and clinical data. Optimized a Random Forest model through feature engineering to achieve high prediction accuracy and delivered insights via an interactive Power BI dashboard highlighting readmission risk, patient profiles, and department-wise trends.
import numpy as np
import pandas as pd
